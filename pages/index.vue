<template>
  <v-app light>
    ...
    <v-content>
          ...
          <v-layout row align-center justify-center class="white--text">
            <transition name="fade" mode="out-in">
              <ChooseEntity
                v-if="type === null"
                @Home::isUser="type = 1"
                @Home::isSociety="type = 2"
              />
              <UserIsSearching v-if="type == 1" />
              <v-card v-if="type === 2" key="2">TYPE 2</v-card>
            </transition>
          </v-layout>
        </v-parallax>
      </section>
      ...
      <section>
        <v-parallax
          src="https://vuetifyjs.com/themes/parallax-starter/assets/section.jpeg"
          height="380"
        >
...
<script>
import ChooseEntity from '../components/Home/ChooseEntity'
import UserIsSearching from '../components/Home/UserIsSearching'
