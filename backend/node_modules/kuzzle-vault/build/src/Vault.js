...
const Cryptonomicon_1 = require("./Cryptonomicon");
class Vault {
    /**
    ...
    constructor(vaultKey) {
        ...
        if (KUZZLE_VAULT_KEY && KUZZLE_VAULT_KEY.length > 0) {
            this.cryptonomicon = new Cryptonomicon_1.default(KUZZLE_VAULT_KEY);
        }
        else if (vaultKey) {
            this.cryptonomicon = new Cryptonomicon_1.default(vaultKey);
        }
        else {
            this.cryptonomicon = new Cryptonomicon_1.default();
        }
        this.secrets = {};
    }
    /**
     ...
     */
    static getParser(encryptedVaultPath) {
     ...
     */
    decrypt(encryptedVaultPath, options) {
