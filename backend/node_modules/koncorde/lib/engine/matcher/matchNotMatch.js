...
exports.MatchNotMatch = void 0;
const ObjectMatcher_1 = require("../../util/ObjectMatcher");
/**
 ...
 */
function MatchNotMatch(operand, testTables, document) {
    const filters = operand.custom.filters;
    const subfilters = filters
        .filter(filterInfo => !ObjectMatcher_1.matchAny(document, filterInfo.value))
        .map(filterInfo => filterInfo.subfilter);
    if (subfilters.length > 0) {
        testTables.addMatch(subfilters);
    }
}
exports.MatchNotMatch = MatchNotMatch;
//# sourceMappingURL=matchNotMatch.js.map